...
export default async function CustomersTable({
  ...
  return (
    <div className="w-full">
      <h1 className={`${bricolage_grotesque.className} mb-8 text-xl md:text-2xl`}>
        Customers
      </h1>
      ...
      <div className="mt-6 flow-root">
        <div className="overflow-x-auto">
          <div className="inline-block min-w-full align-middle">
            <div className="overflow-hidden rounded-md bg-zinc-50 dark:bg-zinc-900 p-2 md:pt-0">
              <div className="md:hidden">
                {customers?.map((customer) => (
                  ...
                  >
                    ...
                    <div className="flex w-full items-center justify-between border-b dark:border-b-zinc-700 py-5">
              ...
              <table className="hidden min-w-full rounded-md text-zinc-900 dark:text-zinc-200 md:table">
                <thead className="rounded-md bg-zinc-50 dark:bg-zinc-900 text-left text-sm font-normal">
                  <tr>
